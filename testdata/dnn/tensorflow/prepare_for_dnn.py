...
def optimize_for_inference(tool, in_node, out_node, out_graph='optimized_graph.pb',
...
def prepare_for_dnn(net, ckpt, freeze_graph_tool, optimizer_tool, transform_graph_tool,
                    input_node_name, output_node_name, out_graph):
    freeze_graph(net, ckpt, freeze_graph_tool, output_node_name)
    optimize_for_inference(optimizer_tool, input_node_name, output_node_name, out_graph)
